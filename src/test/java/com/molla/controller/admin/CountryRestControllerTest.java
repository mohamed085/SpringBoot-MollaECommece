...
class CountryRestControllerTest {
    ...
    @Autowired
    public CountryRestControllerTest(MockMvc mockMvc, ObjectMapper objectMapper, CountryRepository repo) {
        super();
    ...
    public void testListCountries() throws Exception {
        String url = "/admin/countries/list";
    ...
    public void testCreateCountry() throws JsonProcessingException, Exception {
        String url = "/admin/countries/save";
    ...
    public void testDeleteCountry() throws Exception {
        Integer countryId = 7;
        String url = "/admin/countries/delete/" + countryId;
