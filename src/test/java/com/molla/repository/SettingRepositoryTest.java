...
class SettingRepositoryTest {
    ...
    public void testCreateGeneralSettings() {
        Setting siteName = new Setting("SITE_NAME", "Molla ECommerce", SettingCategory.GENERAL);
        Setting siteLogo = new Setting("SITE_LOGO", "Molla.png", SettingCategory.GENERAL);
